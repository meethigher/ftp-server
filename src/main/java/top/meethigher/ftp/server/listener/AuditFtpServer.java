 ...
 */
public class AuditFtpServer implements FtpServer {

    private final Logger LOG = LoggerFactory.getLogger(AuditFtpServer.class);
     ...
     */
    public AuditFtpServer(final FtpServerContext serverContext) {
    ...
    public void start() throws FtpException {
        ...
        try {
            ...
            LOG.info("FTP server started on port: {}", serverContext.getListener("default").getPort());
        } catch (Exception e) {
