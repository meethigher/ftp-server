 ...
 */
public class AuditNioListener extends AbstractListener {

    private final Logger LOG = LoggerFactory.getLogger(AuditNioListener.class);
     ...
     */
    @Deprecated
    public AuditNioListener(String serverAddress, int port, boolean implicitSsl, SslConfiguration sslConfiguration, DataConnectionConfiguration dataConnectionConfig, int idleTimeout, List<InetAddress> blockedAddresses, List<Subnet> blockedSubnets) {
     ...
     */
    public AuditNioListener(String serverAddress, int port, boolean implicitSsl, SslConfiguration sslConfiguration, DataConnectionConfiguration dataConnectionConfig, int idleTimeout, SessionFilter sessionFilter) {
    ...
    public synchronized void start(FtpServerContext context) {
        ...
        try {
            ...
            acceptor.getFilterChain().addLast("logger", new AuditFTPLoggingFilter());
